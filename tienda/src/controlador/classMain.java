...
public class classMain {//NOSONAR
    public static void main(String[] args){
        ...
        NewClass nc=new NewClass(lg,adm, lDAO, a, a1 , lp, lproductos,cajv,admB, admM, admPR, admPM, adPM, adSPM, lrp, lmp, lrprod, lmproducto,cajRegC,cajRegV,cajU);//aqui se van agregando las instanciaciones 
        nc.iniciar();
