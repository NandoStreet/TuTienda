...
CREATE TABLE `logistica_has_proveedor` (
  ...
  CONSTRAINT `fk_logistica_has_proveedor_proveedor1` FOREIGN KEY (`proveedor_idproveedor`) REFERENCES `proveedor` (`idproveedor`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `usuarios` (
  ...
  CONSTRAINT `fk_usuarios_roles1` FOREIGN KEY (`roles_idrol`) REFERENCES `roles` (`idrol`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `usuarios` VALUES (1,'moises','ventura',74607575,1,'moises@gmail.com','12345','huaycan',922145151,1),(2,'david','pablo',7125687,2,'david@gmail.com','qwerty','independencia',963258741,1),(3,'daniel','gonzales',74125896,3,'daniel@gmail.com','98765','callao',987654321,1);
...
-- Dump completed on 2021-11-25 11:59:23
